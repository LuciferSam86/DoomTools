 ...
 */
public final class DoomDependenciesMain 
{
	private static final String DOOM_VERSION = Common.getVersionString("doom");
	private static final String VERSION = Common.getVersionString("doomdeps");
	private static final String SPLASH_VERSION = "Doom Dependencies (DoomDeps) v" + VERSION + " by Matt Tropiano (using DoomStruct v" + DOOM_VERSION + ")";
	...
	{
		out.println("Usage: doomdeps [--help | -h | --version]");
