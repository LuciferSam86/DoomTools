...
/**
 * Main class for WadUnmerge.
 * @author Matthew Tropiano
 */
public final class WadUnMergeMain 
{
	private static final String DOOM_VERSION = Common.getVersionString("doom");
	private static final String VERSION = Common.getVersionString("wadunmerge");
	private static final String SPLASH_VERSION = "WadUnMerge v" + VERSION + " by Matt Tropiano (using DoomStruct v" + DOOM_VERSION + ")";
	...
	{
		out.println("Usage: wadunmerge [--help | -h | --version]");
